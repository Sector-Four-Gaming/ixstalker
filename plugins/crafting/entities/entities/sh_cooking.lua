...
if (SERVER) then
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		ix.util.drawText("A stove with all the appropriate tools and devices for cooking all manner of foods.", x, y + 16, ColorAlpha(color_white, 255), 1, 1, "ixSmallFont", 255 * 0.65)
	end
end