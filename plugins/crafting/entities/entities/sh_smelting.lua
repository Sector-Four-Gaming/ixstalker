...
if (SERVER) then
	...
	function ENT:Think()
		...
		local enttable = ents.FindInSphere(vec, 100)
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		ix.util.drawText("Smelter", x, y, ColorAlpha(ix.config.get("color"), 255), 1, 1, nil, 255 * 0.65)
		ix.util.drawText("A rather large device with the capacity to smelt down various metals as well as perform similar processes.", x, y + 16, ColorAlpha(color_white, 255), 1, 1, "ixSmallFont", 255 * 0.65)
	end
end